...
;Variables aqui------------------------------------------------  
    ...
    mensajeInvalidFormato db 0Dh,0Ah, "Entrada invalida. Utilice el formato -Nombre Apellido 1 Apellido 2 Nota-$"
...
buscar:
    ...
    dec bl  ;porque el indice empieza en 1
    mov bh,0
...
validarNota proc
    ...
    mov di,si   ;DI=puntero 
    mov bp,cx   ;BP=longitud
